...
def generate_pick_path_as_dict(gt_library_warehouse, books_per_pick_path, source):  # type: (GTLibraryGridWarehouse, int, (int, int)) -> dict
    ...
    G_subgraph = gt_library_warehouse.get_subgraph_on_book_locations(unordered_books_locations, source)
    ...
    optimal_pick_path_in_library = gt_library_warehouse.get_pick_path_in_library(ordered_locations, source)
    ...
    return gt_library_warehouse.get_pick_path_as_dict(
        unordered_books,
